...
*AgentsApi* | [**cancel_agent_delegation**](docs/AgentsApi.md#cancel_agent_delegation) | **POST** /agent/delegations/{id}/cancel | Cancel an agent delegation
...
*AgentsApi* | [**get_agent_delegation**](docs/AgentsApi.md#get_agent_delegation) | **GET** /agent/delegations/{id} | Get an agent delegation
...
*AgentsApi* | [**list_thread_agent_delegations**](docs/AgentsApi.md#list_thread_agent_delegations) | **GET** /agent/threads/{thread_id}/delegations | List pending agent delegations for a thread
...
## Documentation For Models
 ...
 - [AgentDelegation](docs/AgentDelegation.md)
 - [AgentInvokeAsyncConfig](docs/AgentInvokeAsyncConfig.md)
 ...
 - [ListThreadAgentDelegations200Response](docs/ListThreadAgentDelegations200Response.md)
 ...
 - [PendingDelegation](docs/PendingDelegation.md)
