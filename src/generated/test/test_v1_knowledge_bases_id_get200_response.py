...
class TestV1KnowledgeBasesIdGet200Response(unittest.TestCase):
    """V1KnowledgeBasesIdGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1KnowledgeBasesIdGet200Response:
        """Test V1KnowledgeBasesIdGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1KnowledgeBasesIdGet200Response`
        """
        model = V1KnowledgeBasesIdGet200Response()
        if include_optional:
            return V1KnowledgeBasesIdGet200Response(
                knowledge_base = None
            )
        else:
            return V1KnowledgeBasesIdGet200Response(
    ...
    def testV1KnowledgeBasesIdGet200Response(self):
        """Test V1KnowledgeBasesIdGet200Response"""
