...
class TestAgentAttachmentOneOf(unittest.TestCase):
    """AgentAttachmentOneOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AgentAttachmentOneOf:
        """Test AgentAttachmentOneOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AgentAttachmentOneOf`
        """
        model = AgentAttachmentOneOf()
        if include_optional:
            return AgentAttachmentOneOf(
                id = '',
                file_url = '',
                file_name = '',
                file_type = ''
    ...
    def testAgentAttachmentOneOf(self):
        """Test AgentAttachmentOneOf"""
