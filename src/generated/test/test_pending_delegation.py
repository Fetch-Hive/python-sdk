...
class TestPendingDelegation(unittest.TestCase):
    """PendingDelegation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PendingDelegation:
        """Test PendingDelegation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PendingDelegation`
        """
        model = PendingDelegation()
        if include_optional:
    ...
    def testPendingDelegation(self):
        """Test PendingDelegation"""
