...
from fetch_hive_sdk.api.public_workflow_runs_api import PublicWorkflowRunsApi


class TestPublicWorkflowRunsApi(unittest.TestCase):
    """PublicWorkflowRunsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = PublicWorkflowRunsApi()

    def tearDown(self) -> None:
        pass

    def test_v1_workflow_runs_id_get(self) -> None:
        """Test case for v1_workflow_runs_id_get
