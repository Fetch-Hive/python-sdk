...
class TestHiveAgentSources(unittest.TestCase):
    """HiveAgentSources unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HiveAgentSources:
        """Test HiveAgentSources
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HiveAgentSources`
        """
        model = HiveAgentSources()
        if include_optional:
            return HiveAgentSources(
                website_urls = [
                    ''
                    ],
                asset_ids = [
