...
class TestAvatarObject(unittest.TestCase):
    """AvatarObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AvatarObject:
        """Test AvatarObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AvatarObject`
        """
        model = AvatarObject()
        if include_optional:
            return AvatarObject(
