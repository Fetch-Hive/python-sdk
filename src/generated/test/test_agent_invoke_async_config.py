...
class TestAgentInvokeAsyncConfig(unittest.TestCase):
    """AgentInvokeAsyncConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AgentInvokeAsyncConfig:
        """Test AgentInvokeAsyncConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AgentInvokeAsyncConfig`
        """
        model = AgentInvokeAsyncConfig()
        if include_optional:
            return AgentInvokeAsyncConfig(
    ...
    def testAgentInvokeAsyncConfig(self):
        """Test AgentInvokeAsyncConfig"""
