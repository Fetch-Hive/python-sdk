...
class TestPublicWorkspacesWorkspaceIdAgentsPostRequestAgent(unittest.TestCase):
    """PublicWorkspacesWorkspaceIdAgentsPostRequestAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PublicWorkspacesWorkspaceIdAgentsPostRequestAgent:
        """Test PublicWorkspacesWorkspaceIdAgentsPostRequestAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PublicWorkspacesWorkspaceIdAgentsPostRequestAgent`
        """
        model = PublicWorkspacesWorkspaceIdAgentsPostRequestAgent()
        if include_optional:
            return PublicWorkspacesWorkspaceIdAgentsPostRequestAgent(
                name = 'My Agent',
    ...
    def testPublicWorkspacesWorkspaceIdAgentsPostRequestAgent(self):
        """Test PublicWorkspacesWorkspaceIdAgentsPostRequestAgent"""
