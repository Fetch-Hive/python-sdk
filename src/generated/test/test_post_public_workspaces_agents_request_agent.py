...
class TestPostPublicWorkspacesAgentsRequestAgent(unittest.TestCase):
    """PostPublicWorkspacesAgentsRequestAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostPublicWorkspacesAgentsRequestAgent:
        """Test PostPublicWorkspacesAgentsRequestAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostPublicWorkspacesAgentsRequestAgent`
        """
        model = PostPublicWorkspacesAgentsRequestAgent()
        if include_optional:
            return PostPublicWorkspacesAgentsRequestAgent(
                name = 'My Agent',
    ...
    def testPostPublicWorkspacesAgentsRequestAgent(self):
        """Test PostPublicWorkspacesAgentsRequestAgent"""
