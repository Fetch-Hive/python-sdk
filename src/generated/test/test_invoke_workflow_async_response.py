...
class TestInvokeWorkflowAsyncResponse(unittest.TestCase):
    """InvokeWorkflowAsyncResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InvokeWorkflowAsyncResponse:
        """Test InvokeWorkflowAsyncResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InvokeWorkflowAsyncResponse`
        """
        model = InvokeWorkflowAsyncResponse()
        if include_optional:
            return InvokeWorkflowAsyncResponse(
                run_id = '',
                status = 'queued'
            )
        else:
    ...
    def testInvokeWorkflowAsyncResponse(self):
        """Test InvokeWorkflowAsyncResponse"""
