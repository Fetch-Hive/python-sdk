...
class TestInvokeHiveAgentResponse(unittest.TestCase):
    """InvokeHiveAgentResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InvokeHiveAgentResponse:
        """Test InvokeHiveAgentResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InvokeHiveAgentResponse`
        """
        model = InvokeHiveAgentResponse()
        if include_optional:
    ...
    def testInvokeHiveAgentResponse(self):
        """Test InvokeHiveAgentResponse"""
