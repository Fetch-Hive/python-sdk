...
class TestUserMembershipObject(unittest.TestCase):
    """UserMembershipObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserMembershipObject:
        """Test UserMembershipObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserMembershipObject`
        """
        model = UserMembershipObject()
        if include_optional:
            return UserMembershipObject(
                id = '',
                role = 'owner',
                is_owner = True,
                is_admin = False,
    ...
    def testUserMembershipObject(self):
        """Test UserMembershipObject"""
