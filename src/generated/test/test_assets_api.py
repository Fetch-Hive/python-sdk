...
class TestAssetsApi(unittest.TestCase):
    ...
    def test_get_public_workspaces_assets(self) -> None:
        """Test case for get_public_workspaces_assets

        List public workspace assets
        """
        pass

    def test_post_public_workspaces_assets(self) -> None:
        """Test case for post_public_workspaces_assets
