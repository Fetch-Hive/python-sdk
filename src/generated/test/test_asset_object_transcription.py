...
class TestAssetObjectTranscription(unittest.TestCase):
    """AssetObjectTranscription unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AssetObjectTranscription:
        """Test AssetObjectTranscription
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AssetObjectTranscription`
        """
        model = AssetObjectTranscription()
        if include_optional:
            return AssetObjectTranscription(
                status = 'pending',
                error_code = '',
                error_message = '',
    ...
    def testAssetObjectTranscription(self):
        """Test AssetObjectTranscription"""
