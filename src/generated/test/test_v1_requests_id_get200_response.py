...
class TestV1RequestsIdGet200Response(unittest.TestCase):
    """V1RequestsIdGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1RequestsIdGet200Response:
        """Test V1RequestsIdGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1RequestsIdGet200Response`
        """
        model = V1RequestsIdGet200Response()
        if include_optional:
            return V1RequestsIdGet200Response(
    ...
    def testV1RequestsIdGet200Response(self):
        """Test V1RequestsIdGet200Response"""
