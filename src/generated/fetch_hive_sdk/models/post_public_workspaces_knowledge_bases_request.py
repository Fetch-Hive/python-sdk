...
class PostPublicWorkspacesKnowledgeBasesRequest(BaseModel):
    """
    PostPublicWorkspacesKnowledgeBasesRequest
    """ # noqa: E501
    knowledge_base: PostPublicWorkspacesKnowledgeBasesRequestKnowledgeBase
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "knowledge_base": PostPublicWorkspacesKnowledgeBasesRequestKnowledgeBase.from_dict(obj["knowledge_base"]) if obj.get("knowledge_base") is not None else None
        })
        return _obj
