...
class PublicWorkspacesWorkspaceIdAgentsPostRequestAgent(BaseModel):
    """
    ...
    max_token: Optional[UUID] = None
    __properties: ClassVar[List[str]] = ["name", "llm_model", "model_type", "description", "instruction_prompt", "temperature", "max_token"]
