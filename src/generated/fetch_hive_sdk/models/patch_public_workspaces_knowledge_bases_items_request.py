...
class PatchPublicWorkspacesKnowledgeBasesItemsRequest(BaseModel):
    """
    PatchPublicWorkspacesKnowledgeBasesItemsRequest
    """ # noqa: E501
    knowledge_base_item: PatchPublicWorkspacesKnowledgeBasesItemsRequestKnowledgeBaseItem
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "knowledge_base_item": PatchPublicWorkspacesKnowledgeBasesItemsRequestKnowledgeBaseItem.from_dict(obj["knowledge_base_item"]) if obj.get("knowledge_base_item") is not None else None
        })
        return _obj
