...
class PublicWorkspacesWorkspaceIdKnowledgeBasesPostRequest(BaseModel):
    """
    PublicWorkspacesWorkspaceIdKnowledgeBasesPostRequest
    """ # noqa: E501
    knowledge_base: PublicWorkspacesWorkspaceIdKnowledgeBasesPostRequestKnowledgeBase
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PublicWorkspacesWorkspaceIdKnowledgeBasesPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PublicWorkspacesWorkspaceIdKnowledgeBasesPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "knowledge_base": PublicWorkspacesWorkspaceIdKnowledgeBasesPostRequestKnowledgeBase.from_dict(obj["knowledge_base"]) if obj.get("knowledge_base") is not None else None
        })
        return _obj
