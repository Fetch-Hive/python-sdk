...
class V1GlobalEmbeddingsPostRequestEmbedding(BaseModel):
    """
    V1GlobalEmbeddingsPostRequestEmbedding
    """ # noqa: E501
    text: StrictStr = Field(description="Text to embed")
    model: Optional[StrictStr] = Field(default=None, description="OpenAI embedding model to use (defaults to text-embedding-3-small)")
