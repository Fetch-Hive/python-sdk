...
class V1GlobalEmbeddingsPostRequest(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "embedding": V1GlobalEmbeddingsPostRequestEmbedding.from_dict(obj["embedding"]) if obj.get("embedding") is not None else None
        })
        return _obj
