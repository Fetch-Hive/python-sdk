...
class PublicSearchServicesCountriesGet200Response(BaseModel):
    """
    PublicSearchServicesCountriesGet200Response
    """ # noqa: E501
    services: List[PublicSearchServicesCountriesGet200ResponseServicesInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "services": [PublicSearchServicesCountriesGet200ResponseServicesInner.from_dict(_item) for _item in obj["services"]] if obj.get("services") is not None else None
        })
        return _obj
