...
class ListThreadAgentDelegations200Response(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "delegations": [AgentDelegation.from_dict(_item) for _item in obj["delegations"]] if obj.get("delegations") is not None else None
        })
        return _obj
