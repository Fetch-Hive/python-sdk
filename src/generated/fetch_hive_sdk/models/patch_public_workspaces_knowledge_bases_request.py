...
class PatchPublicWorkspacesKnowledgeBasesRequest(BaseModel):
    """
    PatchPublicWorkspacesKnowledgeBasesRequest
    """ # noqa: E501
    knowledge_base: Optional[PatchPublicWorkspacesKnowledgeBasesRequestKnowledgeBase] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "knowledge_base": PatchPublicWorkspacesKnowledgeBasesRequestKnowledgeBase.from_dict(obj["knowledge_base"]) if obj.get("knowledge_base") is not None else None
        })
        return _obj
