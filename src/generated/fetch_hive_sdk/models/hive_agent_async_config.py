...
class HiveAgentAsyncConfig(BaseModel):
    """
    HiveAgentAsyncConfig
    """ # noqa: E501
    enabled: StrictBool = Field(description="Must be `true`. Hive Agent invocation is async-only.")
    callback_url: StrictStr = Field(description="HTTPS URL that receives the signed terminal callback.")
