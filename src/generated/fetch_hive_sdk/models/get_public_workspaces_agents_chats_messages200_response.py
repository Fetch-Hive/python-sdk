...
class GetPublicWorkspacesAgentsChatsMessages200Response(BaseModel):
    """
    GetPublicWorkspacesAgentsChatsMessages200Response
    """ # noqa: E501
    messages: List[GetPublicWorkspacesAgentsChatsMessages200ResponseMessagesInner]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetPublicWorkspacesAgentsChatsMessages200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetPublicWorkspacesAgentsChatsMessages200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "messages": [GetPublicWorkspacesAgentsChatsMessages200ResponseMessagesInner.from_dict(_item) for _item in obj["messages"]] if obj.get("messages") is not None else None
        })
        return _obj
