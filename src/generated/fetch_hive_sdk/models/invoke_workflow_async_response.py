...
class InvokeWorkflowAsyncResponse(BaseModel):
    """
    Asynchronous workflow accepted response.
    """ # noqa: E501
    run_id: Optional[StrictStr] = Field(default=None, description="Identifier for the queued workflow run. Use this to poll `GET /v1/workflow_runs/{id}` on the management API. ")
    status: Optional[StrictStr] = Field(default=None, description="Always `\"queued\"` for async responses.")
