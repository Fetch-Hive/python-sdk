...
class PatchPublicWorkspacesAgentsRequest(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "agent": PatchPublicWorkspacesAgentsRequestAgent.from_dict(obj["agent"]) if obj.get("agent") is not None else None
        })
        return _obj
