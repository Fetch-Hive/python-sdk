...
class V1KnowledgeBasesIdPatchRequest(BaseModel):
    """
    V1KnowledgeBasesIdPatchRequest
    """ # noqa: E501
    knowledge_base: Optional[V1KnowledgeBasesIdPatchRequestKnowledgeBase] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "knowledge_base": V1KnowledgeBasesIdPatchRequestKnowledgeBase.from_dict(obj["knowledge_base"]) if obj.get("knowledge_base") is not None else None
        })
        return _obj
