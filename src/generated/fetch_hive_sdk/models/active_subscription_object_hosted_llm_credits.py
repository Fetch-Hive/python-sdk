...
class ActiveSubscriptionObjectHostedLlmCredits(BaseModel):
    """
    ActiveSubscriptionObjectHostedLlmCredits
    """ # noqa: E501
    balance_usd: Union[StrictFloat, StrictInt]
    total_purchased_usd: Union[StrictFloat, StrictInt]
    total_used_usd: Union[StrictFloat, StrictInt]
    enabled: StrictBool
    __properties: ClassVar[List[str]] = ["balance_usd", "total_purchased_usd", "total_used_usd", "enabled"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "total_purchased_usd": obj.get("total_purchased_usd"),
            "total_used_usd": obj.get("total_used_usd"),
