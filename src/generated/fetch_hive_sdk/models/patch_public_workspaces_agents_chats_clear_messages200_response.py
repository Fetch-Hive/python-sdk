...
class PatchPublicWorkspacesAgentsChatsClearMessages200Response(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PatchPublicWorkspacesAgentsChatsClearMessages200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PatchPublicWorkspacesAgentsChatsClearMessages200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "chat": PostPublicWorkspacesAgentsChats200ResponseChat.from_dict(obj["chat"]) if obj.get("chat") is not None else None
        })
        return _obj
