...
class PublicWorkspacesWorkspaceIdAgentsPostRequest(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PublicWorkspacesWorkspaceIdAgentsPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PublicWorkspacesWorkspaceIdAgentsPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "agent": PublicWorkspacesWorkspaceIdAgentsPostRequestAgent.from_dict(obj["agent"]) if obj.get("agent") is not None else None
        })
        return _obj
