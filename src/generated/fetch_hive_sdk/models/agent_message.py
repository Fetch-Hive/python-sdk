...
class AgentMessage(BaseModel):
    ...
    attachments: Optional[List[AgentAttachment]] = Field(default=None, description="Structured external document/image attachments for this historical message.")
    __properties: ClassVar[List[str]] = ["role", "content", "attachments"]
