...
class GetPublicWorkspacesKnowledgeBasesItems200Response(BaseModel):
    """
    GetPublicWorkspacesKnowledgeBasesItems200Response
    """ # noqa: E501
    knowledge_base_items: List[GetPublicWorkspacesKnowledgeBasesItems200ResponseKnowledgeBaseItemsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "knowledge_base_items": [GetPublicWorkspacesKnowledgeBasesItems200ResponseKnowledgeBaseItemsInner.from_dict(_item) for _item in obj["knowledge_base_items"]] if obj.get("knowledge_base_items") is not None else None
        })
        return _obj
