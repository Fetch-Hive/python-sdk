...
class PublicSearchServicesServiceCountriesGet404Response(BaseModel):
    """
    PublicSearchServicesServiceCountriesGet404Response
    """ # noqa: E501
    error: StrictStr
    supported_services: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["error", "supported_services"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PublicSearchServicesServiceCountriesGet404Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PublicSearchServicesServiceCountriesGet404Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "error": obj.get("error"),
            "supported_services": obj.get("supported_services")
        })
        return _obj
