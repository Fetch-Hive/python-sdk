...
class PatchPublicWorkspacesAgentsChatsRequest(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "chat": PatchPublicWorkspacesAgentsChatsRequestChat.from_dict(obj["chat"]) if obj.get("chat") is not None else None
        })
        return _obj
