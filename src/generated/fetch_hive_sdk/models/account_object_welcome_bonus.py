...
class AccountObjectWelcomeBonus(BaseModel):
    """
    ...
    """ # noqa: E501
    amount_usd: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="(value may be null)")
    granted: StrictBool
    granted_at: Optional[datetime] = Field(default=None, description="(value may be null)")
    __properties: ClassVar[List[str]] = ["amount_usd", "granted", "granted_at"]
