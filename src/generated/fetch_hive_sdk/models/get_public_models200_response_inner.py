...
class GetPublicModels200ResponseInner(BaseModel):
    """
    ...
    context_limit: StrictInt
    model_type: StrictStr
    is_image_generation: StrictBool
    is_vision: StrictBool
    is_reasoning: StrictBool
    is_tool_calling: StrictBool
    is_json_schema: StrictBool
    __properties: ClassVar[List[str]] = ["id", "name", "slug", "provider", "provider_name", "context_limit", "model_type", "is_image_generation", "is_vision", "is_reasoning", "is_tool_calling", "is_json_schema"]

    @field_validator('model_type')
    def model_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['llm', 'image_generation']):
            raise ValueError("must be one of enum values ('llm', 'image_generation')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "is_image_generation": obj.get("is_image_generation"),
            "is_vision": obj.get("is_vision"),
            "is_reasoning": obj.get("is_reasoning"),
            "is_tool_calling": obj.get("is_tool_calling"),
            "is_json_schema": obj.get("is_json_schema")
        })
        return _obj
