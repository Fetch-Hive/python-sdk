...
class InvokePromptResponse(BaseModel):
    """
    InvokePromptResponse
    """ # noqa: E501
    request_id: Optional[StrictStr] = Field(default=None, description="Unique identifier for this invocation.")
    response: Optional[StrictStr] = Field(default=None, description="The model's text response. For streaming requests this field is absent; content arrives as `SseChunk` events instead. ")
    model: Optional[StrictStr] = Field(default=None, description="Model identifier used for this invocation.")
    usage: Optional[TokenUsage] = None
    __properties: ClassVar[List[str]] = ["request_id", "response", "model", "usage"]
