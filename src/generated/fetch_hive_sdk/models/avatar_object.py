...
class AvatarObject(BaseModel):
    ...
    AvatarObject
    """ # noqa: E501
    thumb: Optional[StrictStr] = Field(default=None, description="(value may be null)")
    medium: Optional[StrictStr] = Field(default=None, description="(value may be null)")
    large: Optional[StrictStr] = Field(default=None, description="(value may be null)")
    __properties: ClassVar[List[str]] = ["thumb", "medium", "large"]
