...
from fetch_hive_sdk.configuration import Configuration
from fetch_hive_sdk.api_response import ApiResponse, T as ApiResponseT
import fetch_hive_sdk.models
from fetch_hive_sdk import rest
from fetch_hive_sdk.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(fetch_hive_sdk.models, klass)
