...
class HiveAgentsApi:
    ...
    def invoke_hive_agent(
        self,
        invoke_hive_agent_request: InvokeHiveAgentRequest,
        ...
        :param invoke_hive_agent_request: (required)
        :type invoke_hive_agent_request: InvokeHiveAgentRequest
        ...
        _param = self._invoke_hive_agent_serialize(
            invoke_hive_agent_request=invoke_hive_agent_request,
    ...
    @validate_call
    def invoke_hive_agent_with_http_info(
        self,
        invoke_hive_agent_request: InvokeHiveAgentRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[InvokeHiveAgentResponse]:
        """Invoke a Hive Agent
    ...
    @validate_call
    def invoke_hive_agent_without_preload_content(
        self,
        invoke_hive_agent_request: InvokeHiveAgentRequest,
        _request_timeout: Union[
            None,
    ...
    def _invoke_hive_agent_serialize(
        self,
        invoke_hive_agent_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if invoke_hive_agent_request is not None:
            _body_params = invoke_hive_agent_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/hive-agent/invoke',
