...
class PromptsApi:
    ...
    def invoke_prompt(
        self,
        invoke_prompt_request: InvokePromptRequest,
        ...
        :param invoke_prompt_request: (required)
        :type invoke_prompt_request: InvokePromptRequest
        ...
        _param = self._invoke_prompt_serialize(
            invoke_prompt_request=invoke_prompt_request,
    ...
    @validate_call
    def invoke_prompt_with_http_info(
        self,
        invoke_prompt_request: InvokePromptRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[InvokePromptResponse]:
        """Invoke a prompt deployment
    ...
    @validate_call
    def invoke_prompt_without_preload_content(
        self,
        invoke_prompt_request: InvokePromptRequest,
        _request_timeout: Union[
            None,
    ...
    def _invoke_prompt_serialize(
        self,
        invoke_prompt_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if invoke_prompt_request is not None:
            _body_params = invoke_prompt_request
