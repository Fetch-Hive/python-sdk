...
class ModelsApi:
    ...
    def get_public_models(
    ...
    ) -> List[GetPublicModels200ResponseInner]:
        """List active models
        ...
        _param = self._get_public_models_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[GetPublicModels200ResponseInner]",
            '401': "ErrorResponse",
        }
    ...
    @validate_call
    def get_public_models_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[GetPublicModels200ResponseInner]]:
        """List active models
    ...
    @validate_call
    def get_public_models_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_public_models_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
