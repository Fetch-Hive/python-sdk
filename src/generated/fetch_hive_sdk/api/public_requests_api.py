...
class PublicRequestsApi:
    ...
    @validate_call
    def v1_requests_id_get(
        self,
        id: Annotated[StrictStr, Field(description="Request ID (format: req_[32 hex chars])")],
        ...
        :param id: Request ID (format: req_[32 hex chars]) (required)
        :type id: str
        ...
        _param = self._v1_requests_id_get_serialize(
            id=id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "V1RequestsIdGet200Response",
            '401': "ErrorResponse",
            '404': "V1RequestsIdGet404Response",
        }
    ...
    @validate_call
    def v1_requests_id_get_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Request ID (format: req_[32 hex chars])")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[V1RequestsIdGet200Response]:
        """Get a request
    ...
    @validate_call
    def v1_requests_id_get_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Request ID (format: req_[32 hex chars])")],
        _request_timeout: Union[
            None,
    ...
    def _v1_requests_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
